	...
	public static Connection getConnection(String dsn) {
		...
		try {
			if( dsn.equals("mysql") ) {
				...
				Class.forName("oracle.jdbc.OracleDriver");
			    conn = DriverManager.getConnection("jdbc:oracle:thin:@cmoojin21_high?TNS_ADMIN=C:/douzone3/2_Oracle/Wallet_cmoojin21","admin", "xxxxxxAt22cc"); 
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static Connection getConnection(String dsn, String userid, String pwd) {
		...
		try {
			if( dsn.equals("mysql") ) {
				...
				Class.forName("oracle.jdbc.OracleDriver");
			    conn = DriverManager.getConnection("jdbc:oracle:thin:@cmoojin21_high?TNS_ADMIN=C:/douzone3/2_Oracle/Wallet_cmoojin21",userid, pwd); 
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
